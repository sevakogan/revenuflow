...
export function ChartUp({ className, size = 24 }: IconProps) {
  return (
...
export function ChartDown({ className, size = 24 }: IconProps) {
  return (
    <svg className={cn(className)} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 3v18h18" />
      <path d="m7 8 4 4 4-4 5 5" />
      <path d="M16 17h4v-4" />
    </svg>
  );
}
...
export function Play({ className, size = 24 }: IconProps) {
  return (
    <svg className={cn(className)} width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
...
export function Star({ className, size = 24 }: IconProps) {
  return (
    <svg className={cn(className)} width={size} height={size} viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="1">
